...
// testimonials[0] - pushed into HTML already
let indx = 1;
...
const updateTestimonial = function () {
  ...
  if (indx > testimonials.length - 1) indx = 0;
};

const start = setInterval(updateTestimonial, 10000);

// setTimeout(clearInterval(start), 50000);
